...
<svg xmlns='http://www.w3.org/2000/svg' width='640px' height='144px'>
    <foreignObject width='640px' height='144px' requiredExtensions="http://www.w3.org/1999/xhtml">
        ...
        <body xmlns="http://www.w3.org/1999/xhtml" class="h-full w-full">
            <div class="antialiased font-sans bg-white dark:bg-gray-900 dark:text-gray-100 w-full h-full py-4 px-2 ${borderMode ? "rounded-md" : ""} border-gray-800 border flex">
                <div class="flex-shrink-0 flex items-center justify-center pl-4">
                ...
                <div class="flex-grow w-64 flex flex-col justify-center space-y-1 px-4">
